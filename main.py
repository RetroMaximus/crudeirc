...
class CrudeIRC:
    def __init__(self, main_app):
        ...
        self.details_manager = ServerDetailsManager(self)
    ...
    def create_gui(self):
        ...
        self.menu_bar.configure(font=self.nerd_font, background="#36454f", foreground="#eeeeee", borderwidth=-1)
        ...
        self.window_menu.configure(font=self.nerd_font, background="#36454f", foreground="#eeeeee", borderwidth=-1)
        self.file_menu.configure(font=self.nerd_font, background="#36454f", foreground="#eeeeee", borderwidth=-1)
        self.menu_bar.configure(font=self.nerd_font, background="#36454f", foreground="#eeeeee", borderwidth=-1)
    ...
    def open_settings(self):
        self.settings_window(self.root, self.details_manager)
